...
from MMMCGA_auxilary import potential_lrc, pressure_lrc, pressure_delta
...
cv = 1.5 - a_res[2, 0]
cp = 2.5 - a_res[2, 0] + (1.0 + a_res[0, 1] - a_res[1, 1]) * (1.0 + a_res[0, 1] - a_res[1, 1]) / (
            1.0 + 2.0 * a_res[0, 1] + a_res[0, 2]) - 1.0
